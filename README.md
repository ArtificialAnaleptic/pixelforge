...
The suite now also includes a recreation of the **[GB Dot Converter](https://deepblizzard.itch.io/gb-dot-converter)** by DeepBlizzard (@mao_DBmiyuki). This tool allows for highly customizable conversion of images specifically into the classic 4-color Game Boy palette. I highly recommend checking out DeepBlizzard's original work and their other tools on Itch.io!
